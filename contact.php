...
<section class="contact">
   ...
   <div class="row">
      ...
      <div class="image">
         <img src="images/ambiens.jpg" alt="">
      </div>

      <form action="" method="post">
         <h3>Send a Message</h3>
         <input type="text" name="name" maxlength="50" class="box" placeholder="*Name" required>
         <input type="number" name="number" maxlength="10" class="box" placeholder="*Number" required>
         ...
         <input type="submit" value="Submit message" name="send" class="btn">
      </form>
